...
export default function Farmers() {
    ...
    const addMutation = useMutation({
        ...
        onSuccess: () => { invalidate(); toast.success('Farmer added successfully!'); },
        onError: (err) => toast.error('Failed to add farmer: ' + err.message),
    });
    ...
    const deleteMutation = useMutation({
        ...
        onSuccess: () => { invalidate(); toast.success('Farmer deleted.'); },
                    ...
                    <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    required type="text" placeholder="e.g. Tukaram Patil"
                                    value={formData.name}
                            ...
                            <div>
                                ...
                                <div className="flex">
                                    ...
                                    <input
                                        type="tel" pattern="[0-9]{10}" placeholder="9876543210"
            ...
            {confirmDeleteId && (
                <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-xl shadow-xl w-full max-w-sm p-6 text-center">
                        ...
                        <h3 className="text-lg font-bold text-slate-800 mb-1">Delete Farmer?</h3>

...
export default function Dashboard({ onNavigate }) {
    return (
        <div className="min-h-screen bg-slate-50">
            <Header
                title="सप्तश्रृंगी व्हिजीटेबल कंपनी"
                subtitle="Vegetable Merchant & Commission Agent"
            />

            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold devanagari text-slate-900">व्यापारी डॅशबोर्ड</h2>
                    <p className="text-slate-500 mt-2">
                        आजची तारीख: <span className="font-medium text-slate-900">२४ मे, २०२४</span>
                    </p>
                </div>
                ...
                <div className="mt-12 p-6 bg-slate-900 rounded-3xl text-white flex flex-col md:flex-row gap-8 items-center justify-around shadow-2xl">
                    <div className="flex flex-col items-center">
                        ...
                        <span className="text-2xl font-bold">₹ ४५,३००.००</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <span className="text-2xl font-bold">₹ १,२२,८५०.००</span>
                    </div>
                    <div className="w-px h-10 bg-slate-700 hidden md:block"></div>
                    <div className="flex flex-col items-center">
                        <span className="text-slate-400 text-sm mb-1 devanagari">प्रलंबित येणे</span>
                        <span className="text-2xl font-bold text-rose-400">₹ १८,५००.००</span>
                    </div>
                </div>
